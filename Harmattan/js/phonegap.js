...
(function() {
    ...
    Contacts.prototype.find = function(fields, success, fail, options) {
        ...
        var bbContacts = GapContacts.findContacts(filterFields, options.filter, options.multiple);
     ...
     */
    var fieldMappings = {
         "id"                        : { name: "Guid", fields: [ "Guid" ] },
         "displayName"               : { name: "DisplayLabel", fields: [ "Label" ] },
         "name"                      : { name: "Name", fields: [ "Prefix", "FirstName", "LastName" ] },
         "name.formatted"            : { name: "Name", fields: [ "Prefix", "FirstName", "LastName" ] },
         "name.givenName"            : { name: "Name", fields: [ "FirstName" ] },
         "name.familyName"           : { name: "Name", fields: [ "LastName" ] },
         "name.honorificPrefix"      : { name: "Name", fields: [ "Prefix" ] },
         "phoneNumbers"              : { name: "PhoneNumber", fields: [ "PhoneNumber" ] },
         "phoneNumbers.value"        : { name: "PhoneNumber", fields: [ "PhoneNumber" ] },
         "emails"                    : { name: "EmailAddress", fields: [ "EmailAddress" ] },
         "addresses"                 : { name: "Address", fields: [ "Street", "Region", "PostOfficeBox", "Postcode", "Locality", "Country" ] },
         "addresses.formatted"       : { name: "Address", fields: [ "Street", "Region", "PostOfficeBox", "Postcode", "Locality", "Country" ] },
         "addresses.streetAddress"   : { name: "Address", fields: [ "Street" ] },
         "addresses.locality"        : { name: "Address", fields: [ "Locality" ] },
         "addresses.region"          : { name: "Address", fields: [ "Region" ] },
         "addresses.country"         : { name: "Address", fields: [ "Country" ] },
         "organizations"             : { name: "Organization", fields: [ "Name", "Title", "Department" ] },
         "organizations.name"        : { name: "Organization", fields: [ "Name" ] },
         "organizations.title"       : { name: "Organization", fields: [ "Title" ] },
         "organizations.department"  : { name: "Organization", fields: [ "Department" ] },
         "birthday"                  : { name: "Birthday", fields: [ "Birthday" ] },
         "note"                      : { name: "Note", fields: [ "Note" ] },
         "urls"                      : { name: "Url", fields: [ "Url" ] },
         "urls.value"                : { name: "Url", fields: [ "Url" ] },
         "avatar"                    : { name: "Avatar", fields: [ "ImageUrl" ] },
         "ringtone"                  : { name: "Ringtone", fields: [ "AudioRingtoneUrl" ] },
         "gender"                    : { name: "Gender", fields: [ "Gender" ] },
         "anniversary"               : { name: "Anniversary", fields: [ "OriginalDate" ] },
    };
